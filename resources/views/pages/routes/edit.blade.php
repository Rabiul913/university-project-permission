...
<div class="row">
        ...
        <div class="box-header with-border">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form class="form-horizontal"  action="{{ route('routes.update',$route->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <option>----Select vachicle----</option>
                      @foreach($vachicles as $vachicle)
                        <option @if($route->vachicle_id == $vachicle->id) selected="true" @endif value="{{$vachicle->id}}">{{$vachicle->name}}</option>
                        @endforeach
                    </select>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$route->name}}" name="name" id="name" placeholder="destination">
                  </div>
                </div>
                <div class="form-group">
