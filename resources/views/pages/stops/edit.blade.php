...
<div class="row">
        ...
        <div class="box-header with-border">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
          <form class="form-horizontal"  action="{{ route('stops.update',$stop->id) }}" method="POST">
            @csrf
            @method('put')
              <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <option>----Select route----</option>
                      @foreach($routes as $route)
                        <option @if($stop->route_id == $route->id) selected="true" @endif value="{{$route->id}}">{{$route->name}}</option>
                        @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="{{$stop->name}}" name="name" id="name" placeholder="name">
                  </div>
                </div>
